...
const BaseNavigationMenuList = React.forwardRef<
...
BaseNavigationMenuList.displayName = NavigationMenuPrimitive.List.displayName;

const BaseNavigationMenuItem = NavigationMenuPrimitive.Item;
...
>(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Trigger
    ref={ref}
    className={cn(baseNavigationMenuTriggerStyle(), 'group', className)}
    {...props}
  >
    {children}
    {''}
...
BaseNavigationMenuContent.displayName = NavigationMenuPrimitive.Content.displayName;

const BaseNavigationMenuLink = NavigationMenuPrimitive.Link;
...
const BaseNavigationMenuIndicator = React.forwardRef<
...
BaseNavigationMenuIndicator.displayName = NavigationMenuPrimitive.Indicator.displayName;

export {
  BaseNavigationMenu,
  BaseNavigationMenuContent,
  BaseNavigationMenuIndicator,
  BaseNavigationMenuItem,
  BaseNavigationMenuLink,
  BaseNavigationMenuList,
  BaseNavigationMenuTrigger,
  baseNavigationMenuTriggerStyle,
  BaseNavigationMenuViewport,
};
