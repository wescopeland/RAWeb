...
var define_import_meta_env_default = { VITE_PORT: "64009", VITE_BUILD_PATH: "assets/build", VITE_LIVEWIRE_OPT_IN: "true", VITE_PUSHER_APP_KEY: "retroachievements", VITE_PUSHER_HOST: "", VITE_PUSHER_PORT: "443", VITE_PUSHER_SCHEME: "https", VITE_PUSHER_APP_CLUSTER: "mt1", BASE_URL: "/assets/build", MODE: "production", DEV: false, PROD: true, SSR: true };
const appName = define_import_meta_env_default.APP_NAME || "RetroAchievements";
createServer(
  (page) => createInertiaApp({
    page,
    render: ReactDOMServer.renderToString,
    title: (title) => `${title} · ${appName}`,
    resolve: (name) => resolvePageComponent(`./pages/${name}.tsx`, /* @__PURE__ */ Object.assign({ "./pages/HelloWorld.tsx": () => import("./HelloWorld-K1wMIL80.js") })),
    setup: ({ App, props }) => {
